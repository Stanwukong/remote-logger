      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8 leading-relaxed">
            A powerful, TypeScript-first logging SDK with automatic error tracking, performance monitoring, and user
            interaction capture. Similar to Sentry and LogRocket, but with full control over your data.
          </p>
        ...
        <section id="features" className="mb-24">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold mb-4">What Gets Captured Automatically</h2>
            ...
            {[
              {
                ...
                features: ["JavaScript errors", "Promise rejections", "Stack traces", "Source maps"],
              },
              {
                icon: Gauge,
                title: "Performance",
                ...
                features: ["Core Web Vitals", "Resource timing", "Navigation timing", "Memory usage"],
              },
              {
                icon: Network,
                title: "Network",
                ...
                features: ["HTTP requests", "Response times", "Status codes", "Request/response size"],
              },
              {
                icon: Globe,
                title: "Page Views",
                ...
                features: ["Page navigation", "SPA routing", "Referrer tracking", "Session duration"],
              },
              {
                icon: Terminal,
                title: "Console",
                ...
                features: ["Console errors", "Console warnings", "Stack traces", "Arguments capture"],
              },
              {
                icon: MousePointer,
                title: "Interactions",
                ...
                features: ["Click events", "Scroll tracking", "Form interactions", "Element selectors"],
              },
            ].map((feature, index) => (
        ...
        <section id="quickstart" className="mb-24">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold mb-4">Get Started in 30 Seconds</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
  ...
  action: "submit",
                ...
                <div className="space-y-6">
                  <Alert>
                    ...
                    <AlertDescription>
                      <strong>Zero Configuration Required!</strong> The SDK automatically starts capturing errors,
                      performance metrics, network requests, and page views as soon as you initialize it.
                    </AlertDescription>
                  </Alert>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Events captured without any additional code</CardDescription>
                    </CardHeader>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">Uncaught exceptions and promise rejections</p>
                          </div>
                        </div>
                        <div className="flex items-center space-x-3">
                          <Gauge className="w-4 h-4 text-blue-500" />
                          <div>
                            <h4 className="font-semibold text-sm">Performance Monitoring</h4>
                            <p className="text-xs text-muted-foreground">Core Web Vitals, page load times</p>
                          </div>
                        </div>
                        <div className="flex items-center space-x-3">
                          <Network className="w-4 h-4 text-green-500" />
                          <div>
                            <h4 className="font-semibold text-sm">Network Requests</h4>
                            <p className="text-xs text-muted-foreground">Fetch/XHR monitoring with timing</p>
                          </div>
                        </div>
                        <div className="flex items-center space-x-3">
                          <Globe className="w-4 h-4 text-purple-500" />
                          <div>
                            <h4 className="font-semibold text-sm">Page Views</h4>
                            <p className="text-xs text-muted-foreground">Navigation and SPA route changes</p>
                          </div>
                        </div>
                      </div>
                    </CardContent>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Lightweight and performant</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="grid grid-cols-2 gap-4 text-center">
                        <div className="p-3 bg-muted/50 rounded-lg">
                          ...
                          <div className="text-xs text-muted-foreground">Gzipped</div>
                        </div>
                        <div className="p-3 bg-muted/50 rounded-lg">
                          <Activity className="w-6 h-6 mx-auto mb-2 text-green-500" />
                          <div className="font-semibold">Minimal</div>
                          <div className="text-xs text-muted-foreground">CPU Impact</div>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                ...
                <div className="space-y-6">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Fine-tune what gets captured automatically</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CodeBlock
                        language="typescript"
        ...
        warn: LogLevel.ERROR, // Escalate console warnings
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Global context included in all events</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CodeBlock
                        language="typescript"
                ...
                <div className="space-y-6">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Configure batching and delivery</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CodeBlock
                        language="typescript"
    ...
    console.warn('Monita SDK error:', error);
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Built-in data protection</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="space-y-3">
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            <h4 className="font-semibold text-sm">URL Sanitization</h4>
                            <p className="text-xs text-muted-foreground">
                              Removes token, key, password, secret query parameters
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            <h4 className="font-semibold text-sm">Form Protection</h4>
                            <p className="text-xs text-muted-foreground">
                              Keyboard events don&apos;t capture actual keystrokes
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            <h4 className="font-semibold text-sm">Element Safety</h4>
                            <p className="text-xs text-muted-foreground">Uses CSS selectors, not text content</p>
                          </div>
                        </div>
                        <div className="flex items-start space-x-3">
                          <Database className="w-4 h-4 text-green-500 mt-0.5" />
                          <div>
                            <h4 className="font-semibold text-sm">No Storage</h4>
                            <p className="text-xs text-muted-foreground">No localStorage/sessionStorage usage</p>
                          </div>
                        </div>
                      </div>
                    </CardContent>
                ...
                <div className="space-y-6">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Error boundaries and hooks</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CodeBlock
                        language="typescript"
      ...
      component: 'UserDashboard',
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Global error handler and composition API</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CodeBlock
                        language="typescript"
                ...
                <div className="space-y-6">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>App Router and Pages Router support</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CodeBlock
                        language="typescript"
    ...
    throw error;
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Mobile app monitoring and crash reporting</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="text-center py-8">
                        <Rocket className="w-12 h-12 mx-auto mb-4 text-muted-foreground" />
                        <h3 className="font-semibold mb-2">React Native Support</h3>
                        <p className="text-sm text-muted-foreground mb-4">
                          Full React Native support is coming soon with native crash reporting and performance
                          monitoring.
                        </p>
                ...
                <div className="space-y-6">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Verbose logging for debugging</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CodeBlock
                        language="typescript"
    ...
    console.error('Monita SDK error:', error);
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Production-like with extra debugging</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CodeBlock
                        language="typescript"
    ...
    // Silent in production
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Configuration differences at a glance</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                          ...
                          <tbody className="space-y-2">
                            ...
                            <tr className="border-b">
                              <td className="py-2">Batch Size</td>
                              <td className="text-center">1</td>
                              <td className="text-center">25</td>
                              <td className="text-center">100</td>
                            </tr>
                            <tr>
                              <td className="py-2">Flush Interval</td>
                              <td className="text-center">1s</td>
                              <td className="text-center">2s</td>
                              <td className="text-center">5s</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
        ...
        <section className="mb-24">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold mb-4">Beyond Basic Logging</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Essential logging methods</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="space-y-2">
                  <code className="text-sm bg-muted px-2 py-1 rounded">logger.info(message, data?)</code>
                  <code className="text-sm bg-muted px-2 py-1 rounded">logger.warn(message, data?)</code>
                  <code className="text-sm bg-muted px-2 py-1 rounded">logger.error(message, error?)</code>
                  <code className="text-sm bg-muted px-2 py-1 rounded">logger.debug(message, data?)</code>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Advanced error capture</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="space-y-2">
                  <code className="text-sm bg-muted px-2 py-1 rounded">captureException(error, context?)</code>
                  <code className="text-sm bg-muted px-2 py-1 rounded">captureMessage(message, level, data?)</code>
                  <code className="text-sm bg-muted px-2 py-1 rounded">addBreadcrumb(message, category?)</code>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Global and scoped context</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="space-y-2">
                  <code className="text-sm bg-muted px-2 py-1 rounded">setContext(context)</code>
                  <code className="text-sm bg-muted px-2 py-1 rounded">clearContext()</code>
                  <code className="text-sm bg-muted px-2 py-1 rounded">withContext(context, callback)</code>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Performance monitoring methods</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="space-y-2">
                  <code className="text-sm bg-muted px-2 py-1 rounded">startTimer(name)</code>
                  <code className="text-sm bg-muted px-2 py-1 rounded">endTimer(name)</code>
                  <code className="text-sm bg-muted px-2 py-1 rounded">measureFunction(fn, name?)</code>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>SDK lifecycle management</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="space-y-2">
                  <code className="text-sm bg-muted px-2 py-1 rounded">logger.flush()</code>
                  <code className="text-sm bg-muted px-2 py-1 rounded">logger.close()</code>
                  <code className="text-sm bg-muted px-2 py-1 rounded">logger.isEnabled()</code>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="space-y-2">
                  <code className="text-sm bg-muted px-2 py-1 rounded">logger.setLogLevel(level)</code>
                  <code className="text-sm bg-muted px-2 py-1 rounded">logger.enable() / logger.disable()</code>
                  <code className="text-sm bg-muted px-2 py-1 rounded">logger.updateConfig(config)</code>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <section className="mb-24">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold mb-4">Production-Ready Implementation</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-sm">Trust auto-instrumentation</h4>
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5" />
                    <div>
                      <h4 className="font-semibold text-sm">Set meaningful context</h4>
                      <p className="text-sm text-muted-foreground">
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5" />
                    <div>
                      <h4 className="font-semibold text-sm">Configure by environment</h4>
                      <p className="text-sm text-muted-foreground">
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5" />
                    <div>
                      <h4 className="font-semibold text-sm">Add breadcrumbs for complex flows</h4>
                      <p className="text-sm text-muted-foreground">
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5" />
                    <div>
                      <h4 className="font-semibold text-sm">Monitor bundle size impact</h4>
                      <p className="text-sm text-muted-foreground">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-sm">Don&apos;t over-log manually</h4>
                      <p className="text-sm text-muted-foreground">
                  ...
                  <div className="flex items-start space-x-3">
                    <AlertTriangle className="w-4 h-4 text-red-500 mt-0.5" />
                    <div>
                      <h4 className="font-semibold text-sm">Don&apos;t enable all features in production</h4>
                      <p className="text-sm text-muted-foreground">
                  ...
                  <div className="flex items-start space-x-3">
                    <AlertTriangle className="w-4 h-4 text-red-500 mt-0.5" />
                    <div>
                      <h4 className="font-semibold text-sm">Don&apos;t ignore privacy settings</h4>
                      <p className="text-sm text-muted-foreground">
                  ...
                  <div className="flex items-start space-x-3">
                    <AlertTriangle className="w-4 h-4 text-red-500 mt-0.5" />
                    <div>
                      <h4 className="font-semibold text-sm">Don&apos;t forget error boundaries</h4>
                      <p className="text-sm text-muted-foreground">
                  ...
                  <div className="flex items-start space-x-3">
                    <AlertTriangle className="w-4 h-4 text-red-500 mt-0.5" />
                    <div>
                      <h4 className="font-semibold text-sm">Don&apos;t block initialization</h4>
                      <p className="text-sm text-muted-foreground">
            ...
            {[
              {
                ...
                description: "Native crash reporting and performance monitoring for mobile apps",
                status: "In Progress",
                version: "v2.2",
                color: "text-blue-500",
                bgColor: "bg-blue-500/10",
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="hover:shadow-md transition-shadow">
              <CardHeader>
                ...
                <CardDescription>Complete guides, tutorials, and API reference</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:shadow-md transition-shadow">
              <CardHeader>
                ...
                <CardDescription>Real-world examples and integration patterns</CardDescription>
              </CardHeader>
              <CardContent>
                <Button variant="outline" className="w-full bg-transparent" asChild>
                  <Link href="https://github.com/Stanwukong/loghive-sdk" target="_blank">
            ...
            <Card className="hover:shadow-md transition-shadow">
              <CardHeader>
                ...
                <CardDescription>Open source SDK and community contributions</CardDescription>
              </CardHeader>
              <CardContent>
                <Button variant="outline" className="w-full bg-transparent" asChild>

...
const faqItems = [
  {
    question: "How does RemoteLogger handle data security?",
    answer: "RemoteLogger takes security seriously. All data is encrypted in transit and at rest using industry-standard AES-256 encryption. We're SOC 2 Type II compliant and undergo regular security audits. Your logs are stored in isolated environments with strict access controls."
  },
  {
    question: "Can I integrate RemoteLogger with my existing tools?",
    answer: "Yes! RemoteLogger offers extensive integrations with popular tools like Slack, PagerDuty, Datadog, and more. We also provide webhooks and a comprehensive REST API for custom integrations. Our SDK supports all major programming languages and frameworks."
  },
  {
    ...
    <section className="container mx-auto px-4 py-24">
      <div className="text-center mb-16">
        ...
        <p className="text-muted-foreground text-xl max-w-2xl mx-auto">
          Everything you need to know about RemoteLogger
        </p>
      </div>

...
export const fallbackMarketplaceItems: IntegrationMarketplaceItem[] = [
  {
    ...
    slug: "github",
    displayName: "GitHub",
    description: "Create issues and track bugs directly in your GitHub repositories from Monita alerts.",
  ...
  },
  {
    ...
    slug: "jira",
    displayName: "Jira",
    description: "Create Jira tickets automatically from Monita alerts and errors for seamless issue tracking.",
    category: "issue_tracking",
  ...
  },
  {
    ...
    description: "Trigger and resolve PagerDuty incidents automatically from Monita alerts for on-call management.",
  ...
  },
  {
    ...
    slug: "linear",
    displayName: "Linear",
    description: "Create Linear issues from Monita alerts for streamlined project management and bug tracking.",
    category: "issue_tracking",
    requiredFields: ["accessToken"],
